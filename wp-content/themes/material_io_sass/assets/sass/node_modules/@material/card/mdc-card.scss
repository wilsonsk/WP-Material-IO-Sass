...
@import "node_modules/@material/theme/mixins";
@import "node_modules/@material/ripple/mixins";
@import "node_modules/@material/rtl/mixins";
@import "./mixins";
@import "./variables";
...
.mdc-card {
  @include mdc-card-fill-color(orangered);
